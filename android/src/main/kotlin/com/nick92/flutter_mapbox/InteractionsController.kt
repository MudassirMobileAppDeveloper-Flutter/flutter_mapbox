...
import com.nick92.flutter_mapbox.pigeons._InteractionPigeon
import com.nick92.flutter_mapbox.pigeons._InteractionType
import com.nick92.flutter_mapbox.pigeons._InteractionsListener
...
class InteractionsController(private val mapboxMap: MapboxMap, private var context: Context) {
  ...
  fun addInteraction(messenger: BinaryMessenger, channelSuffix: String, call: MethodCall) {
    ...
    val featuresetDescriptor = interaction.featuresetDescriptor?.let {
      com.nick92.flutter_mapbox.pigeons.FeaturesetDescriptor.fromList(it)
    }
