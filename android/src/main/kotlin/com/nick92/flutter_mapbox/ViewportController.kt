...
import com.nick92.flutter_mapbox.pigeons._DefaultViewportTransitionOptions
import com.nick92.flutter_mapbox.pigeons._EasingViewportTransitionOptions
import com.nick92.flutter_mapbox.pigeons._FlyViewportTransitionOptions
import com.nick92.flutter_mapbox.pigeons._FollowPuckViewportStateBearing
import com.nick92.flutter_mapbox.pigeons._FollowPuckViewportStateOptions
import com.nick92.flutter_mapbox.pigeons._OverviewViewportStateOptions
import com.nick92.flutter_mapbox.pigeons._ViewportMessenger
import com.nick92.flutter_mapbox.pigeons._ViewportStateStorage
import com.nick92.flutter_mapbox.pigeons._ViewportStateType
import com.nick92.flutter_mapbox.pigeons._ViewportTransitionStorage
import com.nick92.flutter_mapbox.pigeons._ViewportTransitionType
...
fun ViewportPlugin.viewportStateFromFLTState(
  ...
  return when (stateStorage.type) {
    ...
    _ViewportStateType.CAMERA -> CameraViewportState(
      (stateStorage.options as com.nick92.flutter_mapbox.pigeons.CameraOptions).toCameraOptions(
        context
      ),
      mapboxMap
    )
