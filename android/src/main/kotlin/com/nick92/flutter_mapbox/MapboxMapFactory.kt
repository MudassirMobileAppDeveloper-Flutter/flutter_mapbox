...
class MapboxMapFactory(
  ...
  override fun create(context: Context?, viewId: Int, args: Any?): PlatformView {
    ...
    val mapOptions = params["mapOptions"] as com.nick92.flutter_mapbox.pigeons.MapOptions?
    val cameraOptions = params["cameraOptions"] as com.nick92.flutter_mapbox.pigeons.CameraOptions?
