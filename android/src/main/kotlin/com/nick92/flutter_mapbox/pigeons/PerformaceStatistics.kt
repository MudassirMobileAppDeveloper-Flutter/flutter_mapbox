...
class PerformanceStatisticsListener(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  ...
  fun onPerformanceStatisticsCollected(statisticsArg: PerformanceStatistics, callback: (Result<Unit>) -> Unit) {
    ...
    val channelName = "dev.flutter.pigeon.flutter_mapbox.PerformanceStatisticsListener.onPerformanceStatisticsCollected$separatedMessageChannelSuffix"
...
interface _PerformanceStatisticsApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: _PerformanceStatisticsApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.startPerformanceStatisticsCollection$separatedMessageChannelSuffix", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.stopPerformanceStatisticsCollection$separatedMessageChannelSuffix", codec)
        if (api != null) {
