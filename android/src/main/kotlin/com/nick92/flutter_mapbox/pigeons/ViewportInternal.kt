...
interface _ViewportMessenger {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: _ViewportMessenger?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_mapbox._ViewportMessenger.transition$separatedMessageChannelSuffix", codec)
        if (api != null) {
