...
class GesturesSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: GesturesSettingsInterface?, messageChannelSuffix: String = "") {
    ...
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.GesturesSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.GesturesSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _LocationComponentSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _LocationComponentSettingsInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._LocationComponentSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSettingsChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSettings()
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._LocationComponentSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
...
class ScaleBarSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ScaleBarSettingsInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.ScaleBarSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSettingsChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSettings()
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.ScaleBarSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
...
class CompassSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: CompassSettingsInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.CompassSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSettingsChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSettings()
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.CompassSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
...
class AttributionSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AttributionSettingsInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.AttributionSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSettingsChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSettings()
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.AttributionSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
...
class LogoSettingsInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: LogoSettingsInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.LogoSettingsInterface.getSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSettingsChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSettings()
    ...
    let updateSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.LogoSettingsInterface.updateSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateSettingsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
