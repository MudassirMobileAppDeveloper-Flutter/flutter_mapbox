...
class _ViewportMessengerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _ViewportMessenger?, messageChannelSuffix: String = "") {
    ...
    let transitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._ViewportMessenger.transition\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
