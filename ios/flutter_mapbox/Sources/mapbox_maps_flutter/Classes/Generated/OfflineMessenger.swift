...
class _OfflineManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _OfflineManager?, messageChannelSuffix: String = "") {
    ...
    let loadStylePackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.loadStylePack\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeStylePackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.removeStylePack\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addStylePackLoadProgressListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.addStylePackLoadProgressListener\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stylePackChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.stylePack\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stylePackMetadataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.stylePackMetadata\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let allStylePacksChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineManager.allStylePacks\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _TileStoreSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _TileStore?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let loadTileRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.loadTileRegion\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addTileRegionLoadProgressListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.addTileRegionLoadProgressListener\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let estimateTileRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.estimateTileRegion\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addTileRegionEstimateProgressListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.addTileRegionEstimateProgressListener\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tileRegionMetadataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.tileRegionMetadata\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tileRegionContainsDescriptorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.tileRegionContainsDescriptor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let allTileRegionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.allTileRegions\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tileRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.tileRegion\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.removeRegion\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setOptionForKeyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStore.setOptionForKey\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _OfflineMapInstanceManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _OfflineMapInstanceManager?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let setupOfflineManagerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineMapInstanceManager.setupOfflineManager\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tearDownOfflineManagerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineMapInstanceManager.tearDownOfflineManager\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _TileStoreInstanceManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _TileStoreInstanceManager?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let setupTileStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStoreInstanceManager.setupTileStore\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tearDownTileStoreChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._TileStoreInstanceManager.tearDownTileStore\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _OfflineSwitchSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _OfflineSwitch?, messageChannelSuffix: String = "") {
    ...
    ///
    /// @param connected Set false to disconnect the Mapbox stack
    let setMapboxStackConnectedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineSwitch.setMapboxStackConnected\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return True if the Mapbox stack is disconnected via setMapboxStackConnected(), false otherwise.
    let isMapboxStackConnectedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._OfflineSwitch.isMapboxStackConnected\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
