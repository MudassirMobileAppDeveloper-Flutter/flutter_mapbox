...
class OnSnapshotStyleListener: OnSnapshotStyleListenerProtocol {
  ...
  func onDidFinishLoadingStyle(completion: @escaping (Result<Void, SnapshotterMessengerError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.OnSnapshotStyleListener.onDidFinishLoadingStyle\(messageChannelSuffix)"
  ...
  func onDidFullyLoadStyle(completion: @escaping (Result<Void, SnapshotterMessengerError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.OnSnapshotStyleListener.onDidFullyLoadStyle\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func onDidFailLoadingStyle(message messageArg: String, completion: @escaping (Result<Void, SnapshotterMessengerError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.OnSnapshotStyleListener.onDidFailLoadingStyle\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onStyleImageMissing(imageId imageIdArg: String, completion: @escaping (Result<Void, SnapshotterMessengerError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.OnSnapshotStyleListener.onStyleImageMissing\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
class _SnapshotterInstanceManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _SnapshotterInstanceManager?, messageChannelSuffix: String = "") {
    ...
    let setupSnapshotterForSuffixChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterInstanceManager.setupSnapshotterForSuffix\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tearDownSnapshotterForSuffixChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterInstanceManager.tearDownSnapshotterForSuffix\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _SnapshotterMessengerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _SnapshotterMessenger?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.getSize\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.setSize\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCameraStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.getCameraState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.setCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let startChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.start\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cancelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.cancel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let coordinateBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.coordinateBounds\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.camera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let tileCoverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.tileCover\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._SnapshotterMessenger.clearData\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
