...
class _MapRecorderMessengerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapRecorderMessenger?, messageChannelSuffix: String = "") {
    ...
    ///
    /// @param options MapRecorderOptions to control recording.
    let startRecordingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.startRecording\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return the Uint8List containing the recorded sequence in raw format.
    let stopRecordingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.stopRecording\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param recordedSequence Sequence recorded with stopRecording method.
    /// @param options Options to customize the behaviour of the playback.
    let replayChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.replay\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Temporarily pauses or resumes playback if already paused.
    let togglePauseReplayChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.togglePauseReplay\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the string description of the current state of playback.
    let getPlaybackStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.getPlaybackState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
