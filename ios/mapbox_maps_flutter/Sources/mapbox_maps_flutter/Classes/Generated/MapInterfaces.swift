...
class _AnimationManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _AnimationManager?, messageChannelSuffix: String = "") {
    ...
    let easeToChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.easeTo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let flyToChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.flyTo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pitchByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.pitchBy\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let scaleByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.scaleBy\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.moveBy\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let rotateByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.rotateBy\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cancelCameraAnimationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._AnimationManager.cancelCameraAnimation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _CameraManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _CameraManager?, messageChannelSuffix: String = "") {
    ...
    /// @param offset The center of the given bounds relative to map center in screen points.
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinatesPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.cameraForCoordinatesPadding\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param offset The center of the given bounds relative to map center in screen points.
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinateBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.cameraForCoordinateBounds\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.cameraForCoordinates\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object with the zoom level adjusted to fit `coordinates` into the `box`.
    let cameraForCoordinatesCameraOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.cameraForCoordinatesCameraOptions\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object representing the provided parameters.
    let cameraForGeometryChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.cameraForGeometry\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The `coordinate bounds` object representing a given `camera`.
    ///
    let coordinateBoundsForCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinateBoundsForCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The `coordinate bounds` object representing a given `camera`.
    ///
    let coordinateBoundsForCameraUnwrappedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinateBoundsForCameraUnwrapped\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The object representing `coordinate bounds` and `zoom` for a given `camera`.
    ///
    let coordinateBoundsZoomForCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinateBoundsZoomForCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The object representing `coordinate bounds` and `zoom` for a given `camera`.
    ///
    let coordinateBoundsZoomForCameraUnwrappedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinateBoundsZoomForCameraUnwrapped\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `screen coordinate` on the screen in `logical pixels`.
    let pixelForCoordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.pixelForCoordinate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A geographical `coordinate` corresponding to a given `screen coordinate`.
    let coordinateForPixelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinateForPixel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `screen coordinates` in `logical pixels` for a given geographical `coordinates`.
    let pixelsForCoordinatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.pixelsForCoordinates\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `geographical coordinates` that correspond to a given `screen coordinates`.
    let coordinatesForPixelsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.coordinatesForPixels\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param cameraOptions The new `camera options` to be set.
    let setCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.setCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The current `camera state`.
    let getCameraStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.getCameraState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param options The `camera bounds options` to set.
    /// @return A string describing an error if the operation was not successful, expected with `void` value otherwise.
    let setBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.setBounds\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the `camera bounds` of the map.
    /// @return A `camera bounds` of the map.
    let getBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._CameraManager.getBounds\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _InteractionsListener: _InteractionsListenerProtocol {
  ...
  func onInteraction(feature featureArg: FeaturesetFeature?, context contextArg: MapContentGestureContext, interactionID interactionIDArg: String, completion: @escaping (Result<Void, MapInterfacesError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox._InteractionsListener.onInteraction\(messageChannelSuffix)"
...
class _MapInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapInterface?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let loadStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.loadStyleURI\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let loadStyleJsonChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.loadStyleJson\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.clearData\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTileCacheBudgetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setTileCacheBudget\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `size` of the map in `logical pixels`.
    let getSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getSize\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Triggers a repaint of the map.
    let triggerRepaintChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.triggerRepaint\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param inProgress The `boolean` value representing if a gesture is in progress.
    let setGestureInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setGestureInProgress\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if a gesture is currently in progress, `false` otherwise.
    let isGestureInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.isGestureInProgress\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// For internal use only.
    /// Dispatch a map gesture event for testing purposes.
    let dispatchChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.dispatch\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param inProgress The `boolean` value representing if user animation is in progress
    let setUserAnimationInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setUserAnimationInProgress\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if a user animation is currently in progress, `false` otherwise.
    let isUserAnimationInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.isUserAnimationInProgress\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param delta The new prefetch zoom delta.
    let setPrefetchZoomDeltaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setPrefetchZoomDelta\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The map's prefetch zoom `delta`.
    let getPrefetchZoomDeltaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getPrefetchZoomDelta\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the north `orientation mode`.
    let setNorthOrientationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setNorthOrientation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the map `constrain mode`.
    let setConstrainModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setConstrainMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the `viewport mode`.
    let setViewportModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setViewportMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The map's `map options`.
    let getMapOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getMapOptions\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getDebugOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getDebugOptions\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setDebugOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setDebugOptions\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return An array of `map debug options` flags currently set to the map.
    let getDebugChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getDebug\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param value A `boolean` value representing the state for a given `map debug options`.
    ///
    let setDebugChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setDebug\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The `query features completion` called when the query completes.
    /// @return A list of `QueriedRenderedFeature` objects representing the query results.
    let queryRenderedFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.queryRenderedFeatures\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// If omitted, the full viewport is queried.
    /// @param filter An additional filter for features.
    let queryRenderedFeaturesForFeaturesetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.queryRenderedFeaturesForFeatureset\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param options The `source query options` for querying source features.
    /// @param completion The `query features completion` called when the query completes.
    let querySourceFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.querySourceFeatures\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature collection or a string describing an error if the operation was not successful.
    let getGeoJsonClusterLeavesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getGeoJsonClusterLeaves\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature collection or a string describing an error if the operation was not successful.
    let getGeoJsonClusterChildrenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getGeoJsonClusterChildren\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature extension value containing a value or a string describing an error if the operation was not successful.
    let getGeoJsonClusterExpansionZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getGeoJsonClusterExpansionZoom\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId The feature identifier of the feature whose state should be updated.
    /// @param state The `state` object with properties to update with their respective new values.
    let setFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setFeatureState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId Identifier of the feature whose state should be updated.
    /// @param state Map of entries to update with their respective new values
    let setFeatureStateForFeaturesetDescriptorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setFeatureStateForFeaturesetDescriptor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param feature The feature to update.
    /// @param state Map of entries to update with their respective new values
    let setFeatureStateForFeaturesetFeatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setFeatureStateForFeaturesetFeature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A String representing the Feature's state map.
    let getFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getFeatureState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return  The Feature's state map or an empty map if the feature could not be found.
    let getFeatureStateForFeaturesetDescriptorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getFeatureStateForFeaturesetDescriptor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return  The Feature's state map or an empty map if the feature could not be found.
    let getFeatureStateForFeaturesetFeatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getFeatureStateForFeaturesetFeature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId The feature identifier of the feature whose state should be removed.
    /// @param stateKey The key of the property to remove. If `null`, all feature's state object properties are removed.
    let removeFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.removeFeatureState\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId Identifier of the feature whose state should be removed.
    /// @param stateKey The key of the property to remove. If `nil`, all feature's state object properties are removed. Defaults to `nil`.
    let removeFeatureStateForFeaturesetDescriptorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.removeFeatureStateForFeaturesetDescriptor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param feature An interactive feature to update.
    /// @param stateKey The key of the property to remove. If `nil`, all feature's state object properties are removed. Defaults to `nil`.
    let removeFeatureStateForFeaturesetFeatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.removeFeatureStateForFeaturesetFeature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param featureset A featureset descriptor
    let resetFeatureStatesForFeaturesetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.resetFeatureStatesForFeatureset\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Reduces memory use. Useful to call when the application gets paused or sent to background.
    let reduceMemoryUseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.reduceMemoryUse\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param coordinate The `coordinate` defined as longitude-latitude pair.
    /// @return The elevation (in meters) multiplied by current terrain exaggeration, or empty if elevation for the coordinate is not available.
    let getElevationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.getElevation\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns array of tile identifiers that cover current map camera.
    let tileCoverChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.tileCover\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Note: This method has no effect on iOS platform.
    let setSnapshotLegacyModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setSnapshotLegacyMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// This property allows setting a custom glyph URL at runtime, making it easier to
    /// apply custom fonts to the map without modifying the base style.
    let styleGlyphURLChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.styleGlyphURL\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// This property allows setting a custom glyph URL at runtime, making it easier to
    /// apply custom fonts to the map without modifying the base style.
    let setStyleGlyphURLChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapInterface.setStyleGlyphURL\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class ProjectionSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Projection?, messageChannelSuffix: String = "") {
    ...
    ///
    /// @return Returns the distance measured in meters.
    let getMetersPerPixelAtLatitudeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Projection.getMetersPerPixelAtLatitude\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns Spherical Mercator ProjectedMeters coordinates.
    let projectedMetersForCoordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Projection.projectedMetersForCoordinate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a longitude-latitude pair.
    let coordinateForProjectedMetersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Projection.coordinateForProjectedMeters\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a point on the map in Mercator projection.
    let projectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Projection.project\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a coordinate.
    let unprojectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Projection.unproject\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _MapboxOptionsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapboxOptions?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getAccessTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxOptions.getAccessToken\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAccessTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxOptions.setAccessToken\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _MapboxMapsOptionsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapboxMapsOptions?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getBaseUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getBaseUrl\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setBaseUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setBaseUrl\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getDataPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getDataPath\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setDataPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setDataPath\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getAssetPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getAssetPath\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAssetPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setAssetPath\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getFlutterAssetPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getFlutterAssetPath\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getTileStoreUsageModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getTileStoreUsageMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTileStoreUsageModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setTileStoreUsageMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getWorldviewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getWorldview\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setWorldviewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setWorldview\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getLanguageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.getLanguage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setLanguageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.setLanguage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._MapboxMapsOptions.clearData\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      clearDataChannel.setMessageHandler { _, reply in
        api.clearData { result in
          switch result {
...
class SettingsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Settings?, messageChannelSuffix: String = "") {
    ...
    /// @param key A name of the key.
    /// @param value The `value` for the key.
    let setChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Settings.set\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `value` if a key exists in settings otherwise a `null value` will be returned.
    let getChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.Settings.get\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class StyleManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: StyleManager?, messageChannelSuffix: String = "") {
    ...
    ///
    /// @return A string containing a style URI.
    let getStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleURI\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param uri URI where the style should be loaded from.
    let setStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleURI\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A JSON string containing a serialized style.
    let getStyleJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleJSON\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param json A JSON string containing a serialized style.
    let setStyleJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleJSON\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The default `camera options` of the current style in use.
    let getStyleDefaultCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleDefaultCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `transition options` of the current style in use.
    let getStyleTransitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleTransition\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param config A map containing the configuration options of the import.
    /// @param importPosition The import will be positioned according to the ImportPosition parameters. If not specified, then the import is moved to the top of the import stack.
    let addStyleImportFromJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleImportFromJSON\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param config A map containing the configuration options of the import.
    /// @param importPosition The import will be positioned according to the ImportPosition parameters. If not specified, then the import is moved to the top of the import stack.
    let addStyleImportFromURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleImportFromURI\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param json The JSON string to be loaded directly as the import.
    /// @param config A map containing the configuration options of the import.
    let updateStyleImportWithJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.updateStyleImportWithJSON\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param uri URI of the import.
    /// @param config A map containing the configuration options of the import.
    let updateStyleImportWithURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.updateStyleImportWithURI\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///  @param importId Identifier of import to move.
    ///  @param importPosition The import will be positioned according to the ImportPosition parameters. If not specified, then the import is moved to the top of the import stack.
    let moveStyleImportChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.moveStyleImport\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the list containing information about existing style import objects.
    let getStyleImportsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleImports\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param importId Identifier of the style import to remove.
    let removeStyleImportChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeStyleImport\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import schema, containing the default configurations for the style import.
    let getStyleImportSchemaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleImportSchema\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import configuration or a string describing an error if the operation was not successful.
    let getStyleImportConfigPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleImportConfigProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import configuration or a string describing an error if the operation was not successful.
    let getStyleImportConfigPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleImportConfigProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param importId Identifier of the style import.
    /// @param configs A map of style import configurations.
    let setStyleImportConfigPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleImportConfigProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param config The style import config name.
    /// @param value The style import config value.
    let setStyleImportConfigPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleImportConfigProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param transitionOptions The `transition options`.
    let setStyleTransitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleTransition\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let addStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleLayer\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let addPersistentStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addPersistentStyleLayer\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param layerId A style layer identifier.
    /// @return A string describing an error if the operation was not successful, boolean representing state otherwise.
    let isStyleLayerPersistentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.isStyleLayerPersistent\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let removeStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeStyleLayer\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let moveStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.moveStyleLayer\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `true` value if the given style layer exists, `false` otherwise.
    let styleLayerExistsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.styleLayerExists\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The list containing the information about existing style layer objects.
    let getStyleLayersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleLayers\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style layer property name.
    /// @return The `style property value`.
    let getStyleLayerPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleLayerProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLayerPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleLayerProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The style layer properties or a string describing an error if the operation was not successful.
    let getStyleLayerPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleLayerProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLayerPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleLayerProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addStyleSourceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleSource\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style source property name.
    /// @return The value of a `property` in the source with a `sourceId`.
    let getStyleSourcePropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleSourceProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleSourcePropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleSourceProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The style source properties or a string describing an error if the operation was not successful.
    let getStyleSourcePropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleSourceProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleSourcePropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleSourceProperties\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addGeoJSONSourceFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addGeoJSONSourceFeatures\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let updateGeoJSONSourceFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.updateGeoJSONSourceFeatures\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let removeGeoJSONSourceFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeGeoJSONSourceFeatures\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let updateStyleImageSourceImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.updateStyleImageSourceImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param sourceId An identifier of the style source to remove.
    let removeStyleSourceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeStyleSource\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if the given source exists, `false` otherwise.
    let styleSourceExistsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.styleSourceExists\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The list containing the information about existing style source objects.
    let getStyleSourcesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleSources\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns an ordered list of the current style lights.
    let getStyleLightsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleLights\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param flatLight The flat light source.
    let setLightChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setLight\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param ambientLight The ambient light source.
    /// @param directionalLight The directional light source.
    let setLightsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setLights\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param id The unique identifier of the style light in lights list.
    /// @return The style light property value.
    let getStyleLightPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleLightProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLightPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleLightProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleTerrainChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleTerrain\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style terrain property name.
    /// @return The style terrain property value.
    let getStyleTerrainPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleTerrainProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleTerrainPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setStyleTerrainProperty\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `image` for the given `imageId`, or empty if no image is associated with the `imageId`.
    let getStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getStyleImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let removeStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeStyleImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return True if image exists, false otherwise.
    let hasStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.hasStyleImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addStyleModelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.addStyleModel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let removeStyleModelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.removeStyleModel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let invalidateStyleCustomGeometrySourceTileChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.invalidateStyleCustomGeometrySourceTile\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let invalidateStyleCustomGeometrySourceRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.invalidateStyleCustomGeometrySourceRegion\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return `true` iff the style JSON contents, the style specified sprite and sources are all loaded, otherwise returns `false`.
    ///
    let isStyleLoadedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.isStyleLoaded\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Projection that is currently applied to the map
    let getProjectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getProjection\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param projection The projection to be set.
    let setProjectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.setProjection\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param locale The locale to apply for localization
    /// @param layerIds The ids of layers that will localize on, default is null which means will localize all the feasible layers.
    let localizeLabelsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.localizeLabels\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// - Note: This function should only be called after the style is fully loaded; otherwise, the result may be unreliable.
    let getFeaturesetsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox.StyleManager.getFeaturesets\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
