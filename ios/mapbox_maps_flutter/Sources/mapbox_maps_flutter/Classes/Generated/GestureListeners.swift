...
class GestureListener: GestureListenerProtocol {
  ...
  func onTap(context contextArg: MapContentGestureContext, completion: @escaping (Result<Void, GestureListenersError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.GestureListener.onTap\(messageChannelSuffix)"
  ...
  func onLongTap(context contextArg: MapContentGestureContext, completion: @escaping (Result<Void, GestureListenersError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.GestureListener.onLongTap\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([contextArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func onScroll(context contextArg: MapContentGestureContext, completion: @escaping (Result<Void, GestureListenersError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.GestureListener.onScroll\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([contextArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func onZoom(context contextArg: MapContentGestureContext, completion: @escaping (Result<Void, GestureListenersError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.GestureListener.onZoom\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([contextArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
...
class AnnotationInteractionEventsStreamHandler: PigeonEventChannelWrapper<AnnotationInteractionContext> {
  static func register(with messenger: FlutterBinaryMessenger,
    ...
    var channelName = "dev.flutter.pigeon.flutter_mapbox.AnnotationInteractions._annotationInteractionEvents"
