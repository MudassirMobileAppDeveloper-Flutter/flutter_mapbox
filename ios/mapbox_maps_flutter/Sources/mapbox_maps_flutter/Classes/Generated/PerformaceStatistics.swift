...
class PerformanceStatisticsListener: PerformanceStatisticsListenerProtocol {
  ...
  func onPerformanceStatisticsCollected(statistics statisticsArg: PerformanceStatistics, completion: @escaping (Result<Void, PerformaceStatisticsError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.flutter_mapbox.PerformanceStatisticsListener.onPerformanceStatisticsCollected\(messageChannelSuffix)"
...
class _PerformanceStatisticsApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _PerformanceStatisticsApi?, messageChannelSuffix: String = "") {
    ...
    let startPerformanceStatisticsCollectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.startPerformanceStatisticsCollection\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stopPerformanceStatisticsCollectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.stopPerformanceStatisticsCollection\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
