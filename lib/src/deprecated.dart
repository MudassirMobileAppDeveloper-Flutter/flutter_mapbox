...
abstract class OnCircleAnnotationClickListener {
  ...
  static void setUp(
    ...
    var channelName =
        'dev.flutter.pigeon.flutter_mapbox.OnCircleAnnotationClickListener.onCircleAnnotationClick';
...
abstract class OnPointAnnotationClickListener {
  ...
  static void setUp(
    ...
    var channelName =
        'dev.flutter.pigeon.flutter_mapbox.OnPointAnnotationClickListener.onPointAnnotationClick';
    if (messageChannelSuffix.isNotEmpty) {
      channelName += '.$messageChannelSuffix';
    }
...
abstract class OnPolygonAnnotationClickListener {
  ...
  static void setUp(
    ...
    var channelName =
        'dev.flutter.pigeon.flutter_mapbox.OnPolygonAnnotationClickListener.onPolygonAnnotationClick';
    if (messageChannelSuffix.isNotEmpty) {
      channelName += '.$messageChannelSuffix';
    }
...
abstract class OnPolylineAnnotationClickListener {
  ...
  static void setUp(
    ...
    var channelName =
        'dev.flutter.pigeon.flutter_mapbox.OnPolylineAnnotationClickListener.onPolylineAnnotationClick';
    if (messageChannelSuffix.isNotEmpty) {
      channelName += '.$messageChannelSuffix';
    }
