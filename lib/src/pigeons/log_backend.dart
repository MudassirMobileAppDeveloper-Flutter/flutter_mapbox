        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.flutter_mapbox.LogWriterBackend.writeLog$messageChannelSuffix',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.flutter_mapbox.LogWriterBackend.writeLog was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final LoggingLevel? arg_level = (args[0] as LoggingLevel?);
          assert(arg_level != null,
              'Argument for dev.flutter.pigeon.flutter_mapbox.LogWriterBackend.writeLog was null, expected non-null LoggingLevel.');
          final String? arg_message = (args[1] as String?);
          assert(arg_message != null,
              'Argument for dev.flutter.pigeon.flutter_mapbox.LogWriterBackend.writeLog was null, expected non-null String.');
          try {
