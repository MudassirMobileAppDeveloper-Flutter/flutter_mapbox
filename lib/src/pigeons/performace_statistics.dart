        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.flutter_mapbox.PerformanceStatisticsListener.onPerformanceStatisticsCollected$messageChannelSuffix',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.flutter_mapbox.PerformanceStatisticsListener.onPerformanceStatisticsCollected was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PerformanceStatistics? arg_statistics =
              (args[0] as PerformanceStatistics?);
          assert(arg_statistics != null,
              'Argument for dev.flutter.pigeon.flutter_mapbox.PerformanceStatisticsListener.onPerformanceStatisticsCollected was null, expected non-null PerformanceStatistics.');
          try {
...
class _PerformanceStatisticsApi {
  ...
  Future<void> startPerformanceStatisticsCollection(
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.startPerformanceStatisticsCollection$pigeonVar_messageChannelSuffix';
  ...
  Future<void> stopPerformanceStatisticsCollection() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._PerformanceStatisticsApi.stopPerformanceStatisticsCollection$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
