...
class _MapRecorderMessenger {
  ...
  Future<void> startRecording(MapRecorderOptions options) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.startRecording$pigeonVar_messageChannelSuffix';
  ...
  Future<Uint8List> stopRecording() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.stopRecording$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> replay(
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.replay$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> togglePauseReplay() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.togglePauseReplay$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<String> getPlaybackState() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_mapbox._MapRecorderMessenger.getPlaybackState$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
